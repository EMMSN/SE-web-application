<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_by_year.aspx.cs" Inherits="search_by_year" %>
...
<body>
    ...
    <div>
          <asp:TextBox ID="txtyear" runat="server" CssClass="auto-style3" placeholder="    Book Name"
        ...
        <asp:Button ID="Buttonsearch3" runat="server" Text="Search" class="search" />
        <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" 
            BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
            CellSpacing="2" CssClass="auto-style4" AutoGenerateColumns="False" 
            DataSourceID="dsbook3">
            <Columns>
        ...
        <asp:SqlDataSource ID="dsbook3" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            SelectCommand="SELECT * from Book_table where Year_published =@p">
            <SelectParameters>
                <asp:ControlParameter ControlID="txtyear" DefaultValue="-1" Name="p" 
                    PropertyName="Text" />
            </SelectParameters>
        </asp:SqlDataSource>
