<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_all_books.aspx.cs" Inherits="view_all_books" %>
...
<body>
    ...
    <div>
            ...
            <asp:SqlDataSource ID="dsbook4" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT * FROM [Book_table]"></asp:SqlDataSource>
